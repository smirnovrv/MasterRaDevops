...
Процедура ЗаписатьОбъектВИБ(Объект, Тип)
	...
	//Для Каждого ТекЭлемент Из ЗагруженныеОбъекты Цикл
	//			
	//	ЗначениеЭлемента=ТекЭлемент.Значение.СсылкаНаОбъект;
	//	
	//	Если ТипЗнч(ЗначениеЭлемента)=Тип("ДокументСсылка.ПоступлениеТоваров") Тогда
	//		ОБ=ЗначениеЭлемента.ПолучитьОбъект(РежимЗаписиДокумента.Проведение,РежимПроведенияДокумента.Неоперативный);
	//		ОБ.Записать();
	//	КонецЕсли;	
	//		
	//КонецЦикла;
