...
Процедура ЗаполнитьПоЗаказу(НомерСтроки) 
	...
	Если ТипЗнч(текСтрока.КодЗаказа) = Тип("ДокументСсылка.Заявка") Тогда 		
		...
		ИначеЕсли текСтрока.НДС = Перечисления.СтавкиНДС.НДС22 Тогда 
			текСтрока.СуммаНДС      = текСтрока.КодЗаказа.ИтогоЗаВесьЗаказ*22/122;
		иначе
...
Процедура Расчитать()
	...
	иначеЕсли Строка(ТекущиеДанные.НДС) = "20%" Тогда
		...
		КонецЕсли;
	ИначеЕсли Строка(ТекущиеДанные.НДС) = "20% / 120%" Тогда 
		ТекущиеДанные.СуммаНДС = ТекущиеДанные.Сумма/120*20;
	ИначеЕсли Строка(ТекущиеДанные.НДС) = "5%" Тогда
		...
		КонецЕсли;
	ИначеЕсли Строка(ТекущиеДанные.НДС) = "5% /  105%" Тогда 
		ТекущиеДанные.СуммаНДС = ТекущиеДанные.Сумма / 105 * 5;		
	ИначеЕсли Строка(ТекущиеДанные.НДС) = "7%" Тогда 
		...
		КонецЕсли;
	ИначеЕсли Строка(ТекущиеДанные.НДС) = "7% / 107%" Тогда 
		ТекущиеДанные.СуммаНДС = ТекущиеДанные.Сумма / 107 * 7;
	ИначеЕсли Строка(ТекущиеДанные.НДС) = "22%" Тогда 
		...
		КонецЕсли;	
	ИначеЕсли Строка(ТекущиеДанные.НДС) = "22% / 122%" Тогда 
		ТекущиеДанные.СуммаНДС = ТекущиеДанные.Сумма / 122 * 22;	
	КонецЕсли;   
	
	Если Объект.НДС_В_томЧисле Тогда 
		ТекущиеДанные.Всего	= ТекущиеДанные.Сумма; 
		ТекущиеДанные.Сумма = ТекущиеДанные.Сумма - ТекущиеДанные.СуммаНДС;  
	иначе	
...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	СодержаниеНоменклатуры = ПолучитьСодержаниеНоменклатуры(текСтрока.Номенклатура); 
